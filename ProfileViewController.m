...
-(void)initWithCoefficient {
    
    profileY1 = self.view.frame.size.height*0.37;
    profileY2 = self.view.frame.size.height*1.15;
...
-(void)initProfileCustomNavBar {
    ...
    navBar_titleLabel.text = @"Profile";
...
-(void)initWithProFileTitleLabel {
    ...
    if (IS_IPAD) {
         ...
         profileView = [[UIView alloc] initWithFrame:CGRectMake(-1, CGRectGetMaxY(emailLabel.frame), self.view.frame.size.width+2, profileH*10+9)];
    }
    else {
        
        profileView = [[UIView alloc] initWithFrame:CGRectMake(-1, profileY1, self.view.frame.size.width+2, profileH*10+9)];
    }
    ...
    changePasswordTitleLabel.text = @"Change Password";
    ...
    UILabel *genderTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*2, self.view.frame.size.width/2, profileH)];
    ...
    UILabel *birthDayTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*3, self.view.frame.size.width/2, profileH)];
    [birthDayTitleLabel setTextColor:[UIColor blackColor ]];
    birthDayTitleLabel.backgroundColor = [UIColor clearColor];
    birthDayTitleLabel.text = @"Date of Birth";
    ...
    UILabel *heightTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*4, self.view.frame.size.width/2, profileH)];
    ...
    UILabel *weightTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*5, self.view.frame.size.width/2, profileH)];
    ...
    UILabel *cuffSizeTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*6 , self.view.frame.size.width/2 , profileH)];
    ...
    UILabel *measureArmTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*7, self.view.frame.size.width/2, profileH)];
    ...
    UILabel *TapUnitTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*8, self.view.frame.size.width/2, profileH)];
    ...
    UILabel *pressureUnitTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width*0.05, profileY1+profileH*9, self.view.frame.size.width/2, profileH)];
...
-(void)initWithProfileShowValueObjects {
    ...
    sexSegmentControl.frame = CGRectMake(self.view.frame.size.width*0.37, (profileH-self.view.frame.size.height/22)/2+profileH*2+profileY1, self.view.frame.size.width*0.6, self.view.frame.size.height/22);
    ...
    //BirthDay Date
    birthdayLabel = [[UILabel alloc] initWithFrame: CGRectMake(profileX, profileY1+profileH*3 , self.view.frame.size.width*0.6 , profileH)];
    ...
    //身高單位
    //cm Label init
    cmLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX1, profileY1+profileH*4 , self.view.frame.size.width/3 , profileH)];
    ...
    //ft Label init
    ftLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX+25, profileY1+profileH*4, self.view.frame.size.width/3, profileH)];
    ...
    //inch Label init
    inchLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX+85, profileY1+profileH*4, self.view.frame.size.width/3, profileH)];
    ...
    heightLabel_cm_value = [[UILabel alloc] initWithFrame: CGRectMake(profileX, profileY1+profileH*4 ,profileX1-profileX , profileH)];
    ...
    heightLabel_ft_value = [[UILabel alloc] initWithFrame:CGRectMake(profileX, profileY1+profileH*4, profileX1-profileX, profileH)];
    ...
    heightLabel_inch_value = [[UILabel alloc] initWithFrame:CGRectMake(profileX+50, profileY1+profileH*4, profileX1-profileX, profileH)];
    ...
    //體重
    //kg Label init
    kgLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX1, profileY1+profileH*5 , self.view.frame.size.width/3 , profileH)];
    ...
    //weight Label init
    weightLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX, profileY1+profileH*5 , profileX1-profileX , profileH)];
    ...
    cuffSizeLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX, profileY1+profileH*6 , self.view.frame.size.width*0.6 , profileH)];
    ...
    measureArmLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX, profileY1+profileH*7 , self.view.frame.size.width*0.6 , profileH)];
    ...
    //Arm Label
    UILabel *ArmLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileX+45, profileY1+profileH*7 , self.view.frame.size.width*0.6 , profileH)];
    ...
    unitSegmentControl.frame = CGRectMake(self.view.frame.size.width*0.37, (profileH-self.view.frame.size.height/22)/2+profileH*8+profileY1, self.view.frame.size.width*0.6, self.view.frame.size.height/22);
    ...
    pressureSegmentControl.frame = CGRectMake(self.view.frame.size.width*0.37, (profileH-self.view.frame.size.height/22)/2+profileH*9+profileY1, self.view.frame.size.width*0.6, self.view.frame.size.height/22);
...
-(void)initWithMyGoalTitleLabel {
    ...
    systolicPressureTitleLabel.text = @"Systolic Pressure";
    ...
    diastolicPressureTitleLabel.text = @"Diastolic Pressure";
    ...
    myGoalWeightTitleLabel.text = @"Weight";
    ...
    myGoalBodyFatTitleLabel.text = @"Body Fat";
    ...
    thresholdTitleLabel.text = @"Threshold";
    ...
    [riskTitleBtn setTitle:@"Risk Factor" forState:UIControlStateNormal];
    ...
    UIButton *riskSubTitleBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    riskSubTitleBtn.frame = CGRectMake(self.view.frame.size.width*0.53, 0, self.view.frame.size.width*0.35, profileH);
    [riskSubTitleBtn setTitle:@"Diabetes、Heart Faulure" forState:UIControlStateNormal];
    [riskSubTitleBtn setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    riskSubTitleBtn.titleLabel.font = [UIFont systemFontOfSize:12];
    riskSubTitleBtn.titleLabel.adjustsFontSizeToFitWidth = YES;
    riskSubTitleBtn.backgroundColor = [UIColor clearColor];
    riskSubTitleBtn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    [riskSubTitleBtn addTarget:self action:@selector(goRFClick) forControlEvents:UIControlEventTouchUpInside];
    [riskbBtn addSubview:riskSubTitleBtn];
    ...
    dateformatMainLabel.text = @"Select the date format";
    ...
    [deleteAccountBtn setTitle:@"Delete Account" forState:UIControlStateNormal];
...
-(void)goRFClick {
    ...
    [self presentViewController:riskVC animated:true completion:nil];
...
-(void)getLocaldata {
    ...
    //gender 性別
    genderBooL = [self IntValueTransformToBool:[LocalData sharedInstance].UserGender];
...
-(void)saveProfileData{
    ...
    //gender 性別
    int userGender_intValue = [self BoolTransformToInt:genderBooL];
...
-(void)checkPressureUnit:(BOOL)pressureUnit {
    ...
    if (pressureUnit == NO) {
        ...
        myGoal_systolicPressureStr = [NSString stringWithFormat:@"%.1f",sp2value*mmHgTransformTokPa];
        myGoal_systolicPressureLabel.text = myGoal_systolicPressureStr;
        
        double dp2value = [myGoal_diastolicPressureStr doubleValue];
        myGoal_diastolicPressureStr = [NSString stringWithFormat:@"%.1f",dp2value*mmHgTransformTokPa];
        myGoal_diastolicPressurepLabel.text = myGoal_diastolicPressureStr;
