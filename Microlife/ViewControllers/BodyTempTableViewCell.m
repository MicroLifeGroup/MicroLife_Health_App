...
@implementation BodyTempTableViewCell

@synthesize noteBase,typeImage,decorateLine,timeLabel,noteTextView,cellImage,recordView;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        NSArray *arrayOfViews = [[NSBundle mainBundle] loadNibNamed:@"BodyTempTableViewCell" owner:self options:nil];
